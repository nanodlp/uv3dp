	...
	for _, item := range table {
		...
		for n := 0; n < eProp.Size.Layers; n++ {
			...
			if !cmp.Equal(eLayerExposure, rLayerExposure) {
				...
				t.Logf("%+v", eLayerExposure)
				t.Logf("%+v", rLayerExposure)
			}
