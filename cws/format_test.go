...
const (
	testConfigIni = `; github.com/nanodlp/uv3dp uv3dp v0.0.0 64-bits 1-01-01 00:00:00
...
;(Z Lift Feed Rate        = 120.000 mm/min )
;(Z Bottom Lift Feed Rate = 120.000 mm/min )
;(Z Lift Retract Rate     = 200.000 mm/min )
;(Flip X                  = True )
;(Flip Y                  = True )
;(Number of Slices        = 4 )
